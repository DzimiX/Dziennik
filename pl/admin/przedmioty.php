  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        <h1>Przedmioty</h1>
        <div>
            <button type="button" onclick="location.href='/pl/admin/przedmiot-nowy';" class="btn btn-primary">Nowy przedmiot</button>
        </div>
                          ...
                          if(!$result = $connection->query($sql)){
                            ...
                            while($row = $result->fetch_assoc()){
                                echo "<tr>";
                                  ...
                                  echo "</td>";
                                  echo "<td>";
                                  echo "<button class='btn btn-danger' onclick='nauczyciele(".$row['id'].")'>Nauczyciele</button>";
                                  echo "</td>";
                                echo "</tr>";
                            }
                          }
