  ...
  if( !isset($_GET) OR !isset($_GET['id']) ){
    ...
    try {
        ...
        if ($connection->connect_errno!=0){
            ...
            $sql = "SELECT * from przedmioty WHERE id='".$id."' LIMIT 1;";
  ...
  <body>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        <h1><?php echo $przedmiot; ?></h1><a href="/pl/admin/przedmioty"<button class="btn btn-success">Powrót</button></a>
                    ...
                    <?php
                      ...
                      try {
                        ...
                        if ($connection->connect_errno!=0){
                          ...
                          $sql.= "WHERE id_uprawnienia=uprawnienia.id AND id_uprawnienia = 3 ";
                          ...
                          if(!$result = $connection->query($sql)){
                            ...
                            while($row = $result->fetch_assoc()){
                              ...
                              try {
                                  $sql2 = "SELECT * from przedmiot_nauczyciel WHERE id_nauczyciel='".$row['iduser']."' AND id_przedmiot='".$id."' LIMIT 1";
    ...
    <script src="/js/przedmioty-lista.js"></script>
  </body>
</html>