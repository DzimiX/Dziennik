  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    ...
    <main role="main" class="container">
        <div class="starter-template">
              <h1>Wypożyczenia i rezerwacje</h1>
              <button type='button' onclick="location.href='/pl/biblioteka';" class='btn btn-success'>Powrót</button>
              <button type='button' onclick="location.href='/pl/biblioteka/wypozyczenia-nowe';" class='btn btn-primary'>Nowe wypożyczenie</button>
              <?php
                  ...
                  <tbody>
                                    <?php
                                        ...
                                        if ($connection->connect_errno!=0){
                                            ...
                                            $sql = "SELECT * FROM biblioteka_wypozyczone,biblioteka_ksiazki,ksiazka_unikalne,uzytkownicy ";
                                            $sql.= "WHERE biblioteka_wypozyczone.id_ksiazka = biblioteka_ksiazki.id AND id_uzytkownika=uzytkownicy.id AND id_ksiazka_unikalne=ksiazka_unikalne.id;";
                                            ...
                                            while($row = $result->fetch_assoc()){
                                                ...
                                                if ($row['czy_oddane']==1){
                                                    ...
                                                    echo "</td>";
                                                    echo "<td><span style='color:green'>ODDANE</span></td><td><button type=button onclick=\"location.href='/pl/biblioteka/wypozyczenie-nieoddane-bibliotekarz?id_k_u=".$row['id']."&id_u=".$row['id_uzytkownika']."'\" class='btn btn-info'>Oznacz jako nieoddane</button></td>";
                                                    ...
                                                    echo $row['data_wypozyczenie'];
                                                    echo "</td>";
                                                    echo "<td><span style='color:red'>NIE ODDANE</span></td><td><button type=button onclick=\"location.href='/pl/biblioteka/wypozyczenie-oddane-bibliotekarz?id_k_u=".$row['id']."&id_u=".$row['id_uzytkownika']."'\" class='btn btn-warning'>Oznacz jako oddane</button></td>";
                                                }
                                            }
                                            }
